...
The reason for defining the core was to get a weakly streamlined derivation. The following proposition shows that we have done this. It can easily be verified by studying the core of an atomic flow above.

\begin{proposition}\label{PropStreamlinedCore}
Any $\Core(\Phi)$ is weakly streamlined.
\end{proposition}

To extract the core of a derivation is straightforward and we now show how.
