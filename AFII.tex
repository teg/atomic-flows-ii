...
\begin{theorem}
Given a derivation $\vlder{\Phi}{}{\beta}{\alpha}$ and the non-weakly-streamlined atoms $a_1,\bar a_1,\dots,a_n,\bar a_n$ in $\Phi$, the derivation $\vlder{\Norm_n(a_1,\dots,a_n,\Core(\Phi))}{}{\beta}{\alpha}$ is weakly streamlined.
\end{theorem}
