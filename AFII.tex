...
The reason the former substitution works is that we are basically in the following situation (possibly after some weakening reductions):
\[
...
Let $\Choices_k$ be $\Choices$ restricted to $b_1,\dots,b_k$. The base case, $n=0$, is trivial and the inductive case is:
\[
\vlderivation
{
