...
Using the weakening reductions presented in \cite{GuGu08} we can show another approach to obtaining an experiment on the proof $\Phi$ with respect to $a_1,\dots,a_n$.
...
\]
where the atomic flows labeled $a_1,{\bar a}_1,\dots,a_n,{\bar a_n},b_1,{\bar b_1},\dots,b_m,{\bar b}_m$ do not contain interaction nor cointeraction vertices and $A$ does not contain any cointeraction vertices. Now consider the derivation
\[
...
\]
By applying weakening reductions (which are confluent and terminating) we obtain the experiment
\[
\vlderivation
{
 \vlde{}{}{\beta}
...
(-1,-6)*{\afvjm4};
%
(10,-4)*{\afawdm{}{}{}{{\bar a}_n}};
%------------
(16,0)*{\afawdm{}{}{}{b_1}};
(20,0)*{\afawdm{}{}{}{{\bar b}_1}};
%------------
(24,0)*{\cdots};
%------------
(28,0)*{\afawdm{}{}{}{b_m}};
(32,0)*{\afawdm{}{}{}{{\bar b}_m}};
%------------
(42, 0)*{\affr{8}{8}};
(44, 2)*{A};
(42,-6)*{\afvjm4};
...
Note that the atomic flow of the experiment obtained in the proof of Lemma~\ref{LemExperimentExistence} is slightly different from the atomic flow of the experiment obtained in Remark~\ref{RemExperimentExistence}. However, the important fact is that once the method for obtaining the experiment is fixed, the atomic flow of an experiment of a given proof is unique modulo associativity of contractions. This is easily seen from Remark~\ref{RemExperimentExistence}, but it is not difficult to show that the same is true for the experiments obtained in the proof of Lemma~\ref{LemExperimentExistence}. This motivates the following definition:
