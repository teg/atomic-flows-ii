...
\]
Note that no structural inference rules are changed, so the atomic flow associated to the resulting derivation is the same as the atomic flow associated to $\Phi$.
\end{proof}
