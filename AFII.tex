...
\begin{itemize}
  ...
  \item $\xi\vlhole=\vls[\xi'\vlhole.\beta]$ and $\beta$ is not a unit,
  \item $\xi\vlhole=\vls(\xi'\vlhole.\beta)$ and $\beta$ is not a unit.
\end{itemize}
...
\begin{defi}
Given a derivation $\Phi$ from $\alpha$ to $\beta$, where $a_1,\dots,a_n$ are all the atoms that appear in both interaction and cointeraction instances, a \emph{core of\ $\Phi$} is defined as a derivation from $\vls([a_1.\bar a_1].\cdots.[a_n.\bar a_n].\alpha)$ to $\vls[\beta.(a_1.\bar a_1).\cdots.(a_n.\bar a_n)]$ not contaning any interaction nor cointeraction instances on $a_1,\dots,a_n$.
\end{defi}
...
\vlderivation
{
 \vlde{\Psi'}{}{\beta}
 {
  ...
  {
   \vlde{\vls([a.{\bar a}].\Psi)}{}{\vls([a.{\bar a}].\xi\{\ttt\})}
   {
...
\begin{defi}
The \emph{$n$-normaliser} is a derivation scheme over the meta variables $\Phi$ (derivation), $\alpha,\beta$ (formulae) and $a_1,\dots,a_n$ (atoms).
