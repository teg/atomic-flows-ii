...
% TODO: make a convention about ``distinct atoms'' and ``occurring in (co)interaction instances''
...
% TODO: go through everything above this and make sure that it follows the same scheme
