...
\]
where $\phi_1$ is the atomic flow associated with $a$, $\phi_2$ is the atomic flow associated with $b$ and $a$ and $b$ are the only non-weakly-streamlined atoms, then the atomic flow associated with $\Norm_2(a,b,\Core(\Phi))$ is
\[
\atomicflow
{
%cocontraction - top
