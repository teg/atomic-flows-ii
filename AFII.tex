...
Note that Remark~\ref{RemUglyHack} ensures that there is at least one of $a_1,\dots,a_n$ in both the premiss and the conclusion of $\Phi\{\bar a_1,\dots,\bar a_n\ot\fff\}$.
