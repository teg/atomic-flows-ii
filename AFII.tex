...
\begin{defi}
Given a derivation $\Phi$ containing the atom occurrence $a$,
\begin{itemize}
 \item if $a$ is in the conclusion of an inference rule $\rho$ and $\sigma$ is a minimal renaming which renames $a$ and preserves the validity of $\rho$, then the \emph{predecessors of $a$} are the atom occurrences in the premiss of $\rho$ which are renamed by $\sigma$,
