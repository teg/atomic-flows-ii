...
Given a derivation $\vlder{\Phi}{}{\beta}{\alpha}$, consider the derivation, obtained by Lemma~\ref{LemDecompInt}
\[
\vlder{\Phi'}
{\SKS\setminus\{\aid,\aiu\}}
...
\quad,
\]
with the same atomic flow as $\Phi$, where $a_1,\dots,a_n$ are distinct and pairwise non-dual and $b_1,\dots,b_k$ has no atoms in common with $c_1,\dots,c_k$. A core of $\Phi$ is defined to be the derivation
\[
\vlderivation
{
 \vlde{}{\{\acd,\med\}}{\vls[\beta.(a_n.{\bar a_n}).\cdots.(a_1.{\bar a_1})]}
 {
  \vlde{\Phi'}{}{{\vls[\beta.\vlinf{\aiu}{}{\fff}{\vls(c_l.\bar c_l)}.\cdots.\vlinf{\aiu}{}{\fff}{\vls(c_1.\bar c_1)}.(a_n.\bar a_n).\cdots.(a_n.\bar a_n).\cdots.(a_1.\bar a_1).\cdots.(a_1.\bar a_1)]}}
  {
   \vlde{}{\{\acu,\med\}}{{\vls([a_1.\bar a_1].\cdots.[a_1.\bar a_1].\cdots.[a_n.\bar a_n].\cdots.[a_n.\bar a_n].\vlinf{\aid}{}{\vls[b_1.\bar b_1]}{\ttt}.\cdots.\vlinf{\aid}{}{\vls[b_k.\bar b_k]}{\ttt}.\alpha)}}
   {
...
% TODO: change remark since it is no longer a proof
...
% TODO: change the next informal comment and definition since it is no longer a proof
...
Using the weakening reductions presented in \cite{GuglGund:07:Normalis:lr} we can use another approach to obtaining an experiment on the proof $\Phi$ with respect to $a_1,\dots,a_n$:
