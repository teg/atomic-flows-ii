...
By looking at the atomic flows the following proposition is immediate:

\begin{proposition}\label{PropStreamlinedCore}
Any $\Core(\Phi)$ is weakly streamlined.
\end{proposition}

To obtain the core of a derivation is straightforward and we now show how.
