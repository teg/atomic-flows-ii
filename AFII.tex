...
Given a derivation $\Phi$, with unique, non-weakly-streamlined atoms $a_1$, $\dots$, $a_n$, and the atomic flow associated with $\Phi$
\[
\phi\;\;=\;\;\atomicflow
{
...
\]
where, for $1\le i\le n$, $\phi_i$ and $\phi'_i$ do not contain identity or cut vertices and the subflow consisting of $\phi_i$, $\phi'_i$ and the identity and cut vertices connecting them is the non-weakly-streamlined atomic flow associated with the atom $a_i$, we define a \emph{core of $\phi$} to be
\[
\atomicflow
{
...
\begin{definition}
For every $n\ge0$ the \emph{normaliser of degree n}, $\Norm_n$, is an operator whose arguments are a derivation $\vlder{\Phi}{}{\beta}{\alpha}$ and the order of the atoms $a_1$, $\dots$, $a_n$, such that $a_1$, $\dots$, $a_n$ and their duals are all the non-weakly-streamlined atoms in $\Phi$. Let
\[
\Core(\Phi)=
...
\begin{theorem}
Given a derivation $\Phi$ and all the non-weakly-streamlined atoms $a_1$, $\bar a_1$, $\dots$, $a_n$, $\bar a_n$ in $\Phi$, the derivation $\Norm_n(\Phi,a_1,\dots,a_n)$ is weakly streamlined and has the same premiss and conclusion as $\Phi$.
\end{theorem}
...
\]
where $\phi_1$ is the atomic flow associated with $a$, $\phi_2$ is the atomic flow associated with $b$ and $a$ and $b$ are the only non-weakly-streamlined atoms in $\Phi$, then the atomic flow associated with $\Norm_2(\Phi,a,b)$ is
\[
\atomicflow
{
%cocontraction - top
