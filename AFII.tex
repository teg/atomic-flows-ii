...
Given a proof, $\vlproof{\Phi}{}{\beta}$, and atoms $a_1,\dots,a_n$ such that exactly one of $a_1,\dots,a_n$ appears in every interaction rule instance in $\Phi$, then there exists an experiment on $\Phi$ with respect to $a_1,\dots,a_n$.
\end{lem}
