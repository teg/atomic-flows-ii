...
For any proof\/ $\vlproof{\Pi}{\SKS}{\beta}$ and any selection of atoms occuring in $\Pi$, $A$, the $\top$-experiment on $\Pi$ with respect to $A$ is of the form $\vlder{}{\SKS\setminus\{\aid,\aiu\}}{\beta'}{\gamma}$. Where $\beta'$ and $\delta$ are given by Definition~\ref{DefTopExperiment}.
\end{pro}
