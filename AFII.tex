...
\]
In particular this implies that an atomic flow with one of the following shapes
\[
\atomicflow
{
(0,5.5)*{\afvjm3};
...
\]
is unique. We will work under this assumption throughout this paper, and we then say that the atomic flow is \emph{unique modulo associativity of contractions}.
