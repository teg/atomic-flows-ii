...
\begin{rem}
For convenience we sometimes refer to these derivations as inference rules and denote them $\vlinf{\cod^\star}{}{\alpha}{\bigvee_{i=1}^{n}\alpha}$ and $\vlinf{\cou^\star}{}{\bigwedge_{i=1}^{n}\alpha}{\alpha}$. In particular if $n=2$ we write $\vlinf{\cod}{}{\alpha}{\vls[\alpha.\alpha]}$ and $\vlinf{\cou}{}{\vls(\alpha.\alpha)}{\alpha}$.
\end{rem}
...
\begin{itemize}
  ...
  \item substitute each structural inference rule applied to $a^\star$ as follows
\[
\begin{array}{c}
