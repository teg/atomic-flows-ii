...
\begin{defi}
Given a derivation $\Phi$ from $\alpha$ to $\beta$ and all the distinct and pairwise non-dual atoms $a_1,\dots,a_n$ each of which appears in both interaction and cointeraction instances, a \emph{core of\/ $\Phi$} is defined as a derivation 
\[
