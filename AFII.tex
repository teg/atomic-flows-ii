...
\begin{itemize}
\item $\Assignments_k=\{\{b_1,\dots,b_k\}|b_i\in\{a_i,\bar a_i\}\}$ for $0\leq k\leq n$ and
...
Note that the derivation $\Sym(a_1,\dots,a_n)$ is not unique, but it's atomic flow is unique modulo associativity of contractions:
