...
\begin{definition}
For every $n\ge0$ the \emph{normaliser of degree n}, $\Norm_n$, is an operator whose arguments are the atoms $a_1,\dots,a_n$ and a derivation $\vlder{\Phi}{}{\beta}{\alpha}$and whose output is \\$\Break(a_n,\Break(\dots(\Break(a_1,\Core(\Phi)))\dots))$.
\end{definition}
