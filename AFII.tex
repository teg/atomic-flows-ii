...
% TODO: define the use of these things
...
%---------------------------------------
% TODO: label subflows by atom names
\begin{defi}
...
%---------------------------------------
\begin{rem}\label{RemStr}
It immediately follows from the definition that the diagram below describes the shape of a weakly streamlined derivation; the boxes stand for flows obtained by freely composing edges and vertices whose labels are only those indicated on the boxes:
\[
\atomicflow{
(-7,12)*{\afvj4};
(-5,12)*{\cdots};
