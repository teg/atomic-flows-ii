...
\]
%TODO: explain better
where all the edges that might be in paths from the evidenced interaction vertex are colored in red and all the edges that might be in paths to the evidenced cointeraction vertex are colored in green.
\end{remark}
